        ...
        <ul class="pagination">
            {{-- Previous Page Link --}}
             ...
             @if ($halamanaktif ==1)
                ...
                @else
                <li class="page-item">
                    <a class="page-link" href="{{ "dashboard?page=". $halamanaktif-1 }}" rel="prev">@lang('pagination.previous')</a>
                </li>
                @endif
                {{-- Next Page Link --}}
                <li class="page-item">
                  <a class="page-link" href="{{ "dashboard?page=" . $halamanaktif+1 }}" rel="next">@lang('pagination.next')</a>
                </li> 
